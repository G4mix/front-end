# Padrões de Commits - Front-end Gamix

## Padrão de commit

Neste projeto, usamos a ferramenta Commitizen para padronizar nossos commits. Para começar, certifique-se de ter as dependências do Gamix instaladas.
